...
### Added
- Vertical layout mode via `vertical` configuration option
...
### Fixed
- Compatibility with niri 26.04: update niri-ipc to 26.4.0 to handle new cast-related IPC events

## [0.4.1] - 2026-04-16

### Fixed
- Event stream freeze caused by async_channel back-pressure under rapid window events
- Browser drag ghost image snapping cursor to button center

### Changed
- Internal refactor: reduced boilerplate, removed `async-stream` dependency, simplified internals
